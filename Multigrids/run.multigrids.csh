...
ligand_atom_file                                             ${rootdir}/SB_2020_testset/${system}/${system}.lig.am1bcc.mol2
limit_max_ligands                                            no
skip_molecule                                                no
read_mol_solvation                                           no
calculate_rmsd                                               yes
use_rmsd_reference_mol                                       yes
rmsd_reference_filename                                      ${rootdir}/SB_2020_testset/${system}/${system}.lig.am1bcc.mol2
...
setenv num_of_grids `wc -l ../004.multigrids/${system}.primary_residues.dat | awk '{print $1+1}'`
...
foreach residue (`cat ../004.multigrids/${system}.primary_residues.dat`)
...
setenv primary_res ` cat ../004.multigrids/${system}.primary_residues.dat | sed -e 's/\n/ /g'`
echo ${primary_res}

echo "python script"
python /gpfs/projects/rizzo/ccorbo/Building_Stuff/DOCK6_with_ambpdb/multigrid_fp_gen.py ${rootdir}/${system}/002.rec-prep/${system}.rec.clean.mol2 ${system}.resid ${system}.multigrid.in ${primary_res}
