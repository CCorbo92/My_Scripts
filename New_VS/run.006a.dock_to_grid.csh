...
ligand_atom_file                                             ${rootdir}/${system}/005.zinclibs/${vendor}/chunk${chunk}.mol2
...
echo "Chunk ${chunk} completed docking"  >> ${rootdir}/${system}/Docking_Log.txt

mv ${rootdir}/${system}/Docking_Log.txt ${rootdir}/${system}/tmpdock.txt
sort ${rootdir}/${system}/tmpdock.txt >> ${rootdir}/${system}/Docking_Log.txt
...
##################################################
	...
	#sbatch ${system}.${vendor}.${chunk}.qsub.csh > & ${system}.${vendor}.${chunk}.qsub.log
