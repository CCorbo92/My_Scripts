...
ligand_atom_file                                             ${rootdir}/${system}/002.rec-prep/${system}.lig.python.mol2
limit_max_ligands                                            no
skip_molecule                                                no
read_mol_solvation                                           no
calculate_rmsd                                               yes
use_rmsd_reference_mol                                       yes
rmsd_reference_filename                                      ${rootdir}/${system}/002.rec-prep/${system}.lig.python.mol2
...
while (${chunk} < ${num_chunks})
        ...
        mkdir ${rootdir}/${system}/007.cartesian-min/${vendor}/chunk${chunk}/
        cd ${rootdir}/${system}/007.cartesian-min/${vendor}/chunk${chunk}/
        echo "Minimizing chunk named chunk${chunk}_scored.mol2"
...
ligand_atom_file                                             ${rootdir}/${system}/006.dock-to-grid/${vendor}/chunk${chunk}/${vendor}.${chunk}.output_scored.mol2
limit_max_ligands                                            no
skip_molecule                                                no
read_mol_solvation                                           no
calculate_rmsd                                               no
...
echo "Chunk ${chunk} completed minimization"  >> ${rootdir}/${system}/Minimization_Log.txt

mv ${rootdir}/${system}/Minimization_Log.txt ${rootdir}/${system}/tmpmin.txt
sort ${rootdir}/${system}/tmpmin.txt >> ${rootdir}/${system}/Minimization_Log.txt
EOF
