...
if ( ! -e ${rootdir}/${system}/007.cartesian-min-and-rescore/${vendor}/chunks/ ) then
...
rm -rf ${rootdir}/${system}/008.descriptor-rescore/${vendor}
mkdir -p ${rootdir}/${system}/008.descriptor-rescore/${vendor}
...
python ${scriptdir}/phase1.py ${rootdir}/${system}/007.cartesian-min-and-rescore/${vendor}/chunks/
EOF
...
module list
python ${scriptdir}/phase3.py ${rootdir}/${system}/007.cartesian-min-and-rescore/${vendor}/chunks/ ${score} ${max_num}
