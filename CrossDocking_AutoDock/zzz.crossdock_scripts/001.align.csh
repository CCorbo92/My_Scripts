...
set testset = "/gpfs/projects/rizzo/ccorbo/DOCK6_with_ambpdb/SB_2020_testset"
...
open $testset/$system/$system.lig.gast.mol2
open $testset/$system/$system.lig.am1bcc.mol2
mmaker #0 #1 pair ss ss false iter 2.0
matrixcopy #1 #2 #3
write format mol2  1 ${system}.rec.foramber.mol2
write format mol2 2 ${system}.lig.moe.gast.mol2
write format mol2 3 ${system}.lig.moe.am1bcc.mol2
EOF
#############################################
chimera --nogui chimera.com >& chimera.out

mv ${system}.lig.moe.am1bcc.mol2 ${BUILD_DIR}/zzz.master
mv ${system}.lig.moe.gast.mol2 ${BUILD_DIR}/zzz.master
mv ${system}.rec.foramber.mol2 ${BUILD_DIR}/zzz.master
