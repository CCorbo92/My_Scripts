...
/gpfs/software/intel/parallel-studio-xe/2018_3/compilers_and_libraries/linux/mpi/intel64/bin/mpirun -np ${4} /gpfs/projects/rizzo/zzz.programs/dock6.9_mpiv2018.0.3/bin/dock6.mpi -i FLX_actives_submit.in -o FLX_actives_submit.out

grep -B4 "Grid_Score:" ${system}_actives.FLX_scored.mol2 |grep -v "Bonds" | grep -v "Weight" | grep -v "Charge" | grep "##" | awk '{print $3}' | sed 'N;s/\n/ /g'| while read line; do
